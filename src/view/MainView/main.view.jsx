                ...
                <div className="ai-about">
                    ...
                    <div className="ai-about-item">
                        ...
                        <p className="ai-about-text__primary">
                            ...
                            <p>
                                <i class="fab fa-instagram ai-sn-icon fa-3x"></i>
                                <i class="fab fa-odnoklassniki ai-sn-icon fa-3x"></i>
                                <i class="fab fa-twitter ai-sn-icon fa-3x"></i>
                                <i class="fab fa-vk ai-sn-icon fa-3x"></i>
                                <i class="fab fa-facebook-square ai-sn-icon fa-3x"></i>
                            </p>
                        </p>
                        <p>
                            <button>...Или отправьте нам сообщение</button>
                        </p>
                    </div>
                </div>
            </div>
